const products = [
  {
    ...
    features: ['Fit oversize moderno', 'Costuras altas reforzadas', 'Cuello ribb 1x1', 'Algodón peruano de alta calidad', 'Pre-encogido para durabilidad'],
    sizeChart: [
  ...
  },
  {
    ...
    weight: '320g',
    images: ['/images/products/hoodie-grey-1.jpg'],
    description: 'Hoodie premium con capucha ajustable y bolsillo canguro.',
    features: ['Capucha con cordón ajustable', 'Bolsillo canguro frontal', 'Puños y dobladillo acanalados', 'Estampado DTG de alta calidad', 'Material suave y duradero'],
    sizeChart: [
  ...
  },
  {
    ...
    weight: '180g',
    images: ['/images/products/tank-white-1.jpg'],
    description: 'Tank top deportivo ideal para diseños minimalistas y lettering.',
    features: ['Tirantes anchos para comodidad', 'Bajo profundo para mayor libertad', 'Costuras planas reforzadas', 'Absorbe el sudor rápidamente', 'Perfecto para capas o uso individual'],
    sizeChart: [
  ...
  },
  {
    ...
    weight: '280g',
    images: ['/images/products/sweatshirt-navy-1.jpg'],
    description: 'Sweatshirt premium con cuello redondo y mangas largas.',
    features: ['Cuello redondo acanalado', 'Puños y dobladillo acanalados', 'Bordado de alta calidad', 'Material suave y cálido', 'Ideal para climas frescos'],
    sizeChart: [
  ...
  },
  {
    ...
    material: 'Algodón pima 100%',
    weight: '220g',
    images: ['/images/products/polo-military-1.jpg'],
    description: 'Polo premium con cuello mao y tres botones.',
    features: ['Cuello mao con tres botones', 'Mangas cortas con ribb', 'Tinte directo de alta calidad', 'Material transpirable', 'Perfecto para branding corporativo'],
    sizeChart: [
  ...
  },
  {
    ...
    material: 'Algodón peruano 100%',
    weight: '230g',
    images: ['/images/products/tshirt-lightgrey-1.jpg'],
  ...
  },
  {
    ...
    material: 'Algodón pima 100%',
    weight: '180g',
    images: ['/images/products/tank-black-1.jpg'],
